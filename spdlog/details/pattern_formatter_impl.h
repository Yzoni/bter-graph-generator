...
// message counter formatter
        class i_formatter SPDLOG_FINAL:
...
//Full weekday name
    ...
    class A_formatter SPDLOG_FINAL :
...
class B_formatter SPDLOG_FINAL :
...
class c_formatter SPDLOG_FINAL:
...
class D_formatter SPDLOG_FINAL:
...
// year - 4 digit
class Y_formatter SPDLOG_FINAL:
...
// month 1-12
class m_formatter SPDLOG_FINAL:
...
class H_formatter SPDLOG_FINAL:
...
// seconds 0-59
class S_formatter SPDLOG_FINAL:
...
// milliseconds
class e_formatter SPDLOG_FINAL:
...
// microseconds
class f_formatter SPDLOG_FINAL:
...
// AM/PM
class p_formatter SPDLOG_FINAL:
...
class r_formatter SPDLOG_FINAL:
...
class T_formatter SPDLOG_FINAL:
...
class z_formatter SPDLOG_FINAL:
...
// Current pid
class pid_formatter SPDLOG_FINAL:
...
class v_formatter SPDLOG_FINAL:
...
class ch_formatter SPDLOG_FINAL:
...
class aggregate_formatter SPDLOG_FINAL:
...
class full_formatter SPDLOG_FINAL:
